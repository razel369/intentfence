...
export const INTENTFENCE_READINESS_PRICE_USD = "$0.002";
export const INTENTFENCE_READINESS_PRICE_ATOMIC = "2000";
export const INTENTFENCE_US_CPI_PRICE_USD = "$0.001";
export const INTENTFENCE_US_CPI_PRICE_ATOMIC = "1000";
export const INTENTFENCE_POLICY_PACK_PRICE_USD = "$1.00";
export const INTENTFENCE_POLICY_PACK_PRICE_ATOMIC = "1000000";
